...
namespace DataStructures.Tests.Trees.Traverse
{
    ...
    public class PreorderTraverseTests
    {
        ...
        {
            BinaryTree<int> tree = new BinaryTree<int>([1, 2, 3, 4, 5, 6, 7, 8, 9], new() { Traverse = DataStructures.Trees.Interfaces.Traverse.Preorder });
            BinarySearchTree<int> searchTree = new BinarySearchTree<int>([6, 3, 9, 2, 1, 8, 5, 4, 7], new() { Traverse = DataStructures.Trees.Interfaces.Traverse.Preorder });
