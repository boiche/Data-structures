...
using DataStructures.Recursive.Trees.Enumerators.BinaryTree;
using System;
...
namespace DataStructures.Recursive.Trees.Interfaces
{
    ...
    {
        protected BaseBinaryTree(IEnumerable<T> source) : base(source) { }      
        ...
        protected void SetTraversor(TreeOptions options)
        {
